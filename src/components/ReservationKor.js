...
const ReservationKor = () => {
    ...
    return (
        <div>
            ...
            {!confirmed && 
                <Form onSubmit={handleSubmit} className="col-xs-6 col-md-5 d-flex flex-column mx-auto my-5">
                    <h2 className="mx-auto font">방문 예약</h2>
                    <FormGroup>
                        <label htmlFor="name">명함: </label>
                    ...
                    <FormGroup>
                        <label htmlFor="date">월/일/년:</label>
        ...
        {confirmed && <div className="col-6 col-lg-3 d-flex flex-column mx-auto my-5 py-5">
            <h2 className="text-center"><b>{formData.name}</b>님 {formData.time} <br />{formData.date}의 <br />예약은 완료되었습니다.</h2>
